...
ZSH_HIGHLIGHT_STYLES[reserved-word]="fg=${_rose_pine_moon_palette[gold]},bold"
...
ZSH_HIGHLIGHT_STYLES[cursor-matchingbracket]="fg=${_rose_pine_moon_palette[rose]},standout"
