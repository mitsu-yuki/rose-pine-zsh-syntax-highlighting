...
ZSH_HIGHLIGHT_STYLES[reserved-word]="fg=${_rose_pine_dawn_palette[gold]},bold"
...
ZSH_HIGHLIGHT_STYLES[cursor-matchingbracket]="fg=${_rose_pine_dawn_palette[rose]},standout"
