...
ZSH_HIGHLIGHT_STYLES[unknown-token]="fg=${_rose_pine_moon_palette[love]},bold"
ZSH_HIGHLIGHT_STYLES[reserved-word]="fg=${_rose_pine_moon_palette[iris]},bold"
ZSH_HIGHLIGHT_STYLES[alias]="fg=${_rose_pine_moon_palette[pine]}"
ZSH_HIGHLIGHT_STYLES[suffix-alias]="fg=${_rose_pine_moon_palette[pine]}"
ZSH_HIGHLIGHT_STYLES[builtin]="fg=${_rose_pine_moon_palette[foam]}"
ZSH_HIGHLIGHT_STYLES[function]="fg=${_rose_pine_moon_palette[foam]}"
...
ZSH_HIGHLIGHT_STYLES[precommand]="fg=${_rose_pine_moon_palette[rose]}"
...
ZSH_HIGHLIGHT_STYLES[assign]="fg=${_rose_pine_moon_palette[pine]}"
ZSH_HIGHLIGHT_STYLES[named-fd]="fg=${_rose_pine_moon_palette[subtle]},italic"
...
ZSH_HIGHLIGHT_STYLES[parameter-brace]="fg=${_rose_pine_moon_palette[subtle]}"
...
ZSH_HIGHLIGHT_STYLES[default-param]="fg=${_rose_pine_moon_palette[subtle]}"

# Strings and quotes
ZSH_HIGHLIGHT_STYLES[single-quoted-argument]="fg=${_rose_pine_moon_palette[gold]}"
ZSH_HIGHLIGHT_STYLES[single-quoted-argument-unclosed]="fg=${_rose_pine_moon_palette[love]},bold"
ZSH_HIGHLIGHT_STYLES[double-quoted-argument]="fg=${_rose_pine_moon_palette[gold]}"
ZSH_HIGHLIGHT_STYLES[double-quoted-argument-unclosed]="fg=${_rose_pine_moon_palette[love]},bold"
ZSH_HIGHLIGHT_STYLES[dollar-double-quoted-argument]="fg=${_rose_pine_moon_palette[foam]}"
ZSH_HIGHLIGHT_STYLES[dollar-double-quoted-argument-unclosed]="fg=${_rose_pine_moon_palette[love]},bold"
ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument]="fg=${_rose_pine_moon_palette[iris]}"
ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument-unclosed]="fg=${_rose_pine_moon_palette[love]},bold"
ZSH_HIGHLIGHT_STYLES[back-quoted-argument]="fg=${_rose_pine_moon_palette[iris]}"
ZSH_HIGHLIGHT_STYLES[back-quoted-argument-unclosed]="fg=${_rose_pine_moon_palette[love]},bold"
ZSH_HIGHLIGHT_STYLES[back-double-quoted-argument]="fg=${_rose_pine_moon_palette[foam]}"
ZSH_HIGHLIGHT_STYLES[back-double-quoted-argument-unclosed]="fg=${_rose_pine_moon_palette[love]},bold"
ZSH_HIGHLIGHT_STYLES[back-dollar-quoted-argument]="fg=${_rose_pine_moon_palette[iris]}"
ZSH_HIGHLIGHT_STYLES[rc-quote]="fg=${_rose_pine_moon_palette[foam]}"

# Paths, globs, and substitutions
ZSH_HIGHLIGHT_STYLES[globbing]="fg=${_rose_pine_moon_palette[iris]}"
ZSH_HIGHLIGHT_STYLES[history-expansion]="fg=${_rose_pine_moon_palette[rose]}"
ZSH_HIGHLIGHT_STYLES[back-reference]="fg=${_rose_pine_moon_palette[foam]}"
ZSH_HIGHLIGHT_STYLES[path]="fg=${_rose_pine_moon_palette[subtle]},underline"
ZSH_HIGHLIGHT_STYLES[path_prefix]="fg=${_rose_pine_moon_palette[muted]},underline"
ZSH_HIGHLIGHT_STYLES[path_approx]="fg=${_rose_pine_moon_palette[subtle]},underline"
...
ZSH_HIGHLIGHT_STYLES[comment]="fg=${_rose_pine_moon_palette[muted]},italic"
ZSH_HIGHLIGHT_STYLES[c-style-comment]="fg=${_rose_pine_moon_palette[muted]},italic"
ZSH_HIGHLIGHT_STYLES[c-style-comment-unmatched]="fg=${_rose_pine_moon_palette[love]},bold"
ZSH_HIGHLIGHT_STYLES[redirection]="fg=${_rose_pine_moon_palette[rose]}"
ZSH_HIGHLIGHT_STYLES[math]="fg=${_rose_pine_moon_palette[gold]}"
ZSH_HIGHLIGHT_STYLES[if-then-else]="fg=${_rose_pine_moon_palette[iris]}"
ZSH_HIGHLIGHT_STYLES[for-loop]="fg=${_rose_pine_moon_palette[iris]}"
ZSH_HIGHLIGHT_STYLES[for-loop-variable]="fg=${_rose_pine_moon_palette[gold]}"
...
ZSH_HIGHLIGHT_STYLES[cursor-matchingbracket]="fg=${_rose_pine_moon_palette[gold]},standout"

# Miscellaneous
ZSH_HIGHLIGHT_STYLES[equals]="fg=${_rose_pine_moon_palette[rose]}"
ZSH_HIGHLIGHT_STYLES[whitespace]="fg=${_rose_pine_moon_palette[highlight_high]},bg=${_rose_pine_moon_palette[highlight_low]}"
